...
func (t NtlmTransport) RoundTrip(req *http.Request) (res *http.Response, err error) {
	...
	r.Header.Add("Authorization", "NTLM "+util.EncBase64(b.Bytes()))
	...
	if resp.StatusCode == http.StatusUnauthorized {
		...
		challengeBytes, err := util.DecBase64(ntlmChallengeString)
		if err != nil {
			return nil, err
		}
		...
		req.Header.Set("Authorization", "NTLM "+util.EncBase64(authenticate.Bytes()))
